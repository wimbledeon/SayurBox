...
if(isset($_POST['register'])) {
    ...
    $hasil=mysqli_query($conn, "INSERT INTO tb_user SET nama='$nama', alamat='$alamat', no_hp='$no_hp', email='$email', password='$password', level='user'");
    if($hasil){
...
<body class="bg-dark">
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            <div class="card-header text-center">Register Pelanggan Sayur Box</div>
            <div class="card-body">
                <form method="post">
